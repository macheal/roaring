...
[![GoDoc](https://godoc.org/github.com/macheal/roaring?status.svg)](https://godoc.org/github.com/macheal/roaring) [![Go Report Card](https://goreportcard.com/badge/RoaringBitmap/roaring)](https://goreportcard.com/report/github.com/macheal/roaring)

![Go-CI](https://github.com/macheal/roaring/workflows/Go-CI/badge.svg)
![Go-ARM-CI](https://github.com/macheal/roaring/workflows/Go-ARM-CI/badge.svg)
![Go-Windows-CI](https://github.com/macheal/roaring/workflows/Go-Windows-CI/badge.svg)
=============
...
There are also  [Java](https://github.com/macheal/roaringBitmap) and [C/C++](https://github.com/RoaringBitmap/CRoaring) versions.  The Java, C, C++ and Go version are binary compatible: e.g,  you can save bitmaps
from a Java program and load them back in Go, and vice versa. We have a [format specification](https://github.com/macheal/roaringFormatSpec).
...
#### Installation
  ...
  - go get -t github.com/macheal/roaring
...
import (
    "fmt"
    "github.com/macheal/roaring/v2/roaring64"
    "bytes"
)
...
Current documentation is available at https://pkg.go.dev/github.com/macheal/roaring and https://pkg.go.dev/github.com/macheal/roaring/roaring64
...
- go get github.com/macheal/roaring

```go
$ gore
gore version 0.2.6  :help for help
gore> :import github.com/macheal/roaring
gore> x:=roaring.New()
gore> x.Add(1)
gore> x.String()
"{1}"
...
You can help us test further the library with fuzzy testing:
         ...
         go-fuzz-build github.com/macheal/roaring
